        ...
        public static ResponseQuote ParseXmlCapability(string respString)
        {
            ...
            try
            {
                ...
                foreach (XmlNode qtdShp in qtdShpList)
                {
                    ...
                    qShp.ExchangeRate = ExchangeRate != null ? Convert.ToDouble(ExchangeRate.InnerText) : 0;
                    qShp.WeightCharge = Convert.ToDouble(WeightCharge.InnerText);
                    qShp.WeightChargeTax = Convert.ToDouble(WeightChargeTax.InnerText);
                    qShp.TotalTransitDays = Convert.ToInt32(TotalTransitDays.InnerText);
                    qShp.PickupPostalLocAddDays = Convert.ToInt32(PickupPostalLocAddDays.InnerText);
                    qShp.DeliveryPostalLocAddDays = Convert.ToInt32(DeliveryPostalLocAddDays.InnerText);
                    qShp.DeliveryDate = DeliveryDate.InnerText;
                    qShp.DeliveryTime = DeliveryTime.InnerText;
                    qShp.DimensionalWeight = Convert.ToDouble(DimensionalWeight.InnerText);
                    ...
                    foreach (XmlNode qtdShpChrg in qtdShpChrgList)
                    {
                        ...
                        // set to quote class
                        qtdShpExChrg.SpecialServiceType = SpecialServiceType == null ? "" : SpecialServiceType.InnerText;
                        qtdShpExChrg.LocalServiceType = LocalServiceType == null ? "" : LocalServiceType.InnerText;
                        qtdShpExChrg.GlobalServiceName = GlobalServiceName == null ? "" : GlobalServiceName.InnerText;
                        qtdShpExChrg.LocalServiceTypeName = LocalServiceTypeName == null ? "" : LocalServiceTypeName.InnerText;
                        qtdShpExChrg.ChargeCodeType = ChargeCodeType == null ? "" : ChargeCodeType.InnerText;
                        qtdShpExChrg.CurrencyCode = CurrencyCode3 == null ? "" : CurrencyCode3.InnerText;
                        qtdShpExChrg.ChargeValue = ChargeValue == null ? 0 : Convert.ToDouble(ChargeValue.InnerText);
                        qtdShpExChrg.ChargeTaxAmount = ChargeTaxAmount == null ? 0 : Convert.ToDouble(ChargeTaxAmount.InnerText);

                        qtdShpExChrg.ChargeTaxAmountDet = new ChargeTaxAmountDet();
                        qtdShpExChrg.ChargeTaxAmountDet.TaxTypeRate = TaxTypeRate3 == null ? 0 : Convert.ToDouble(TaxTypeRate3.InnerText);
                        qtdShpExChrg.ChargeTaxAmountDet.TaxTypeCode = TaxTypeCode3.InnerText;
                        qtdShpExChrg.ChargeTaxAmountDet.TaxAmount = TaxAmount == null ? 0 : Convert.ToDouble(TaxAmount.InnerText);
                        qtdShpExChrg.ChargeTaxAmountDet.BaseAmount = BaseAmount == null ? 0 : Convert.ToDouble(BaseAmount.InnerText);
                        ...
                        foreach (XmlNode qtdSExtrChrgInAdCur in qtdSExtrChrgInAdCurList)
                        {
                            ...
                            adCur.ChargeValue = ChargeValue2 == null ? 0 : Convert.ToDouble(ChargeValue2.InnerText);
                            adCur.ChargeTaxAmount = ChargeTaxAmount2 == null ? 0 : Convert.ToDouble(ChargeTaxAmount2.InnerText);
                            adCur.CurrencyCode = CurrencyCode4 == null ? "" : CurrencyCode4.InnerText;
                            adCur.CurrencyRoleTypeCode = CurrencyRoleTypeCode2 == null ? "" : CurrencyRoleTypeCode2.InnerText;

                            adCur.ChargeTaxAmountDet = new ChargeTaxAmountDet();

                            adCur.ChargeTaxAmountDet.TaxTypeRate = TaxTypeRate4 == null ? 0 : Convert.ToDouble(TaxTypeRate4.InnerText);
                            adCur.ChargeTaxAmountDet.TaxTypeCode = TaxTypeCode4 == null ? "" : TaxTypeCode4.InnerText;
                            adCur.ChargeTaxAmountDet.TaxAmount = TaxAmount2 == null ? 0 : Convert.ToDouble(TaxAmount2.InnerText);
                            adCur.ChargeTaxAmountDet.BaseAmount = BaseAmount2 == null ? 0 : Convert.ToDouble(BaseAmount2.InnerText);
                    ...
                    qShp.PricingDate = PricingDate == null ? "" : PricingDate.InnerText;
                    qShp.ShippingCharge = ShippingCharge == null ? 0 : Convert.ToDouble(ShippingCharge.InnerText);
                    qShp.TotalTaxAmount = TotalTaxAmount == null ? 0 : Convert.ToDouble(TotalTaxAmount.InnerText);
                    ...
                    foreach (XmlNode qtdSInAdCur in qtdSInAdCurList)
                    {
                        ...
                        AdCur.CurrencyCode = CurrencyCode2 == null ? "" : CurrencyCode2.InnerText;
                        AdCur.CurrencyRoleTypeCode = CurrencyRoleTypeCode == null ? "" : CurrencyRoleTypeCode.InnerText;
                        AdCur.WeightCharge = WeightCharge2 == null ? 0 : Convert.ToDouble(WeightCharge2.InnerText);
                        AdCur.TotalAmount = TotalAmount == null ? 0 : Convert.ToDouble(TotalAmount.InnerText);
                        AdCur.TotalTaxAmount = TotalTaxAmount2 == null ? 0 : Convert.ToDouble(TotalTaxAmount2.InnerText);
                        AdCur.WeightChargeTax = WeightChargeTax2 == null ? 0 : Convert.ToDouble(WeightChargeTax2.InnerText);

                        AdCur.WeightChargeTaxDet = new WeightChargeTaxDet();
                        AdCur.WeightChargeTaxDet.TaxTypeRate = TaxTypeRate == null ? 0 : Convert.ToDouble(TaxTypeRate.InnerText);
                        AdCur.WeightChargeTaxDet.TaxTypeCode = TaxTypeCode == null ? "" : TaxTypeCode.InnerText;
                        AdCur.WeightChargeTaxDet.WeightChargeTax = WeightChargeTax3 == null ? 0 : Convert.ToDouble(WeightChargeTax3.InnerText);
                        AdCur.WeightChargeTaxDet.BaseAmt = BaseAmt == null ? 0 : Convert.ToDouble(BaseAmt.InnerText);
                    ...
                    qShp.WeightChargeTaxDet.TaxTypeRate = TaxTypeRate2 == null ? 0 : Convert.ToDouble(TaxTypeRate2.InnerText);
                    qShp.WeightChargeTaxDet.TaxTypeCode = TaxTypeCode2 == null ? "" : TaxTypeCode2.InnerText;
                    qShp.WeightChargeTaxDet.WeightChargeTax = WeightChargeTax4 == null ? 0 : Convert.ToDouble(WeightChargeTax4.InnerText);
                    qShp.WeightChargeTaxDet.BaseAmt = BaseAmt2 == null ? 0 : Convert.ToDouble(BaseAmt2.InnerText);
